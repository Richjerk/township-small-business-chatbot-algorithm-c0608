        ...
        >
            <div className="mx-auto max-w-7xl">
                <div className="grid sm:grid-cols-3 lg:grid-cols-4 gap-8">
                        ...
                        <div className="pb-8 sm:col-span-3 lg:col-auto">
                            {(logo?.url || title) && (
                                <Link href="/" className="flex flex-col items-start">
                                    {logo && <ImageBlock {...logo} className="inline-block w-auto" data-sb-field-path=".logo" />}
                                    {title && (
                    ...
                    {primaryLinks && <FooterLinksGroup {...primaryLinks} data-sb-field-path=".primaryLinks" />}
                    {secondaryLinks && <FooterLinksGroup {...secondaryLinks} data-sb-field-path=".secondaryLinks" />}
